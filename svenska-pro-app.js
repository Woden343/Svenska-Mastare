...
function renderQuestion() {
  ...
  container.innerHTML = `
    ...
    <div class="flex gap-3 mt-4">
      <button onclick="backToP racticeMenu()" class="flex-1 bg-white border-2 border-slate-300 text-slate-700 font-semibold py-3 rounded-xl hover:border-slate-400 transition">
        ← Retour
      </button>
...
function initSettings() {
  ...
  document.getElementById("btn-open-settings").onclick = () => {
    ...
    document.getElementById("select-goal").value = appState.settings.dailyGoal;
  ...
  document.getElementById("btn-save-settings").onclick = () => {
    ...
    appState.settings.dailyGoal = parseInt(document.getElementById("select-goal").value);
    saveState();
    updateHeaderUI();
