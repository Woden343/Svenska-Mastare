        ...
        ${(() => {
          ...
          if (sections.prof && sections.prof.length) {
            out += `
              <div class="card">
                <div class="row" style="align-items:baseline; gap:12px; margin-bottom:10px;">
                  <span class="section-pill" style="background: rgba(254,204,0,0.18); border-color: rgba(254,204,0,0.22); color:#b45309;">Prof</span>
...
`);
    ...
    document.getElementById("skipPartBtn")?.addEventListener("click", () => {
      // Simple: aller à la prochaine section "importante" si elle existe
      const target = document.querySelector(".quiz") || document.querySelector("[data-quiz]") || document.querySelector(".vocab") || document.querySelector("table");
